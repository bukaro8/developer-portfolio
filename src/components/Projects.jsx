  ...
  return(
    <Fragment>
      ...
      <section  className='projects'>
        <h2 className='about-title projects-title'>My <span className='about-title-orange'>Projects</span></h2>
        <p className='projects-subTitle'>Click on the image to see the project description</p>
        ...
        <picture key={index}className='project-image-container'>
              <a target="_blank" href={item.pathname}>
              <img className='project-image' src={item.imageName} alt="website preview" />
